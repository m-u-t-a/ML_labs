...
train_data = pd.read_csv("C:/Users/Sasha/PycharmProjects/ML_labs/LAB_1/z_datasets/svmdata_d.txt", sep="\t")
test_data = pd.read_csv("C:/Users/Sasha/PycharmProjects/ML_labs/LAB_1/z_datasets/svmdata_d_test.txt", sep="\t")
...
for i, (name, params) in enumerate(kernels):
    ...
    legend_elements = [
        Line2D([0], [0], marker='o', color='w', label='Class 0 (red)',
               markerfacecolor='red', markersize=8, markeredgecolor='k'),
        Line2D([0], [0], marker='o', color='w', label='Class 1 (green)',
